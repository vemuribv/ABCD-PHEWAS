...
number: 5
name: Domain mapping config loads
expected: |
  Run `from abcd_phewas.domain_mapper import load_domain_config; cfg = load_domain_config('config/domain_mapping.yaml'); print([d['name'] for d in cfg])`. Shows all 9 domain names (8 ABCD domains + Other/Unclassified).
